...
import com.hfb.pos.util.LocationUtil;
import com.hfb.pos.util.TrafficUtil;
...
public class ApplicationEnvironment {
	...
	private void initFiles(){
		// 如果是第一次启动系统，首先需要初始化，将assets下所有的文件复制到/data/data/com.hfb.pos/assets下。
...
//		if (0 == currentVersion) {
	...
	***/
	...
	private void cleanUp() {
		...
		// 关闭FSKService
		this.getApplication().stopService(new Intent("com.hfb.pos.fskService"));
		
		// 停止超时服务
		this.getApplication().stopService(new Intent("com.hfb.pos.timeoutService"));
		
		this.getApplication().stopService(new Intent("com.hfb.pos.uploadSignImageService"));
