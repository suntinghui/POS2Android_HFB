...
import com.hfb.pos.agent.client.TransferLogic;
import com.hfb.pos.fsk.CommandControllerEx;
import com.hfb.pos.fsk.FSKService;
import com.hfb.pos.fsk.FSKStateChangeListener;
...
public class ShowBalanceActivity extends BaseActivity implements OnClickListener {
	...
	class ShowBalanceTask extends AsyncTask<Object, Object, Object>{
		...
		protected Object doInBackground(Object... arg0) {
			...
			10-20 01:01:10.810: E/AndroidRuntime(14638): 	at com.hfb.pos.fsk.CommandControllerEx.Cmd_Display(CommandControllerEx.java:122)
			10-20 01:01:10.810: E/AndroidRuntime(14638): 	at com.hfb.pos.activity.ShowBalanceActivity$ShowBalanceTask.doInBackground(ShowBalanceActivity.java:75)
